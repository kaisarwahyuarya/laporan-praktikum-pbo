...
public class Kalkulator1841720206Kaisar extends javax.swing.JFrame {
    double a;
    double b;
    String operation;
    double result;
   
    public Kalkulator1841720206Kaisar() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Kalkulator1841720206Kaisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Kalkulator1841720206Kaisar().setVisible(true);
            }
        });
    }
